...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            GrupoClases grupoClase = db.GrupoClases.Find(id);
            if (grupoClase == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,cod_grupo_clase")] GrupoClases grupoClase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,cod_grupo_clase")] GrupoClases grupoClase)
        {
            if (ModelState.IsValid)
            {
