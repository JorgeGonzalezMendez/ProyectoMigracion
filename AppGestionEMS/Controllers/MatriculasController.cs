...
namespace AppGestionEMS.Controllers
{
    ...
    public class MatriculasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,cod_ultima_matricula,curso,dni_alumno")] Matriculas matriculas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,cod_ultima_matricula,curso,dni_alumno")] Matriculas matriculas)
        {
            if (ModelState.IsValid)
            {
